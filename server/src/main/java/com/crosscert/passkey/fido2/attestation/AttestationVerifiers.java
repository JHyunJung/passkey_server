 ...
 * none}, {@code packed}, {@code apple}, {@code android-key}, {@code android-safetynet}, and {@code
 * fido-u2f}; any other format throws {@code UNSUPPORTED_ATTESTATION_FORMAT} (fail-closed).
 */
